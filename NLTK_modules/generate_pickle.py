...
with open("positive.txt","r") as short_pos:
    for _p in short_pos.readlines():
        p = _p.decode('iso-8859-1').encode("ascii","ignore")
...
with open("negative.txt","r") as short_neg:
    for _p in short_neg.readlines():
        p = _p.decode('iso-8859-1').encode("ascii","ignore")
